...
| `supervisor dashboard-lineage-export` | Exporta Report -> Dataset -> referências M/SQL com IDs canônicos, proveniência, confiança e sistema fonte da primeira tabela; nomes do modelo semântico ficam explícitos como candidatos, não como prova de tabela física |
